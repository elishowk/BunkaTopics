...
export default function GodMode() {
  ...
  const defaultValueStr = typeof window !== "undefined"
  ...
  return (
    <>
      <Dialog open={open} onClose={() => setOpen(false)}>
        ...
        <form onSubmit={(e) => {
          e.preventDefault()
          window.localStorage.setItem('searchOverride', e.currentTarget.override.value)
          setOpen(false)
        }}>
          <DialogContent>
            <DialogContentText>
              Update this JSON file to change the query parameters for all website searches.
            </DialogContentText>
            <TextField
