    ...
    <Box
      ...
      sx={({ palette }) =>
        palette.mode === 'dark'
          ? {
              background:
                'linear-gradient(90deg, rgba(3,3,3,0.2) 0%, rgba(48,48,48,1) 50%, rgba(3,3,3,0.2) 100%)'
            }
          : {}
      }
    >
      ...
      <Box flexGrow={1} position='relative'>
            ...
            >
                      ...
                      <Grid container display='flex'>
                        <Grid item flex={1}>
                          <List dense disablePadding>
                            {suggestions
                              .filter(
                                (_, i) => i < Math.ceil(suggestions.length / 2)
                              )
                              .map(({ keywords, lang }) => (
              ...
              >
                <div>
                  ...
                  >
                    <Image src={CNRSLogo} height='50' alt='CNRS' />
                  </a>
                </div>
                <div>
                  <a
                    ...
                    rel='noreferrer noopener'
                  >
                    <Image src={ENSLogo} height='50' alt='ENS' />
                  </a>
                </div>
                <div>
                  <a
                    ...
                    rel='noreferrer noopener'
                  >
                    <Image src={PrairieLogo} height='50' alt='Prairie' />
                  </a>
                </div>
                <div>
                  <a
                    ...
                    rel='noreferrer noopener'
                  >
                    <Image src={PSLLogo} height='50' alt='PSL' />
                  </a>
                </div>
                <div>
                  <a
        ...
        <Box position='absolute' top='1em' right='1em'>
          ...
          >
            <div>
              <a
                href='https://twitter.com/Bunka_ai'
                title='Twitter @Bunka_ai'
                target='_blank'
                rel='noreferrer noopener'
              >
                <TwitterIcon />
            ...
            <div>
              <a
                href='https://discord.gg/ANMczdtyVg'
                title='Discord Bunka'
                target='_blank'
                rel='noreferrer noopener'
              >
            ...
            <IconButton onClick={switchMode} size='small'>
              {theme.palette.mode === 'dark' ? (
                <LightModeIcon />
              ) : (
                <DarkModeIcon />
